<template>
  ...
  <div class="flex flex-col items-center">
    ...
    <button @click="randomUserStore.getRandomUser" class="flex fill-white justify-center items-center bg-purple-500 text-white text-xl font-medium py-2 w-full max-w-[500px] rounded-lg cursor-pointer mt-5 hover:bg-purple-700 transition ">
