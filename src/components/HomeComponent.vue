<template>
  ...
  <div class="flex flex-col items-center">
    <div class="w-50 h-50 relative rounded-[50%] overflow-hidden z-0 [filter:drop-shadow(0_4px_10px_rgba(168,85,247,0.5))]">
      <div class="bg-gray-400 absolute left-0 top-0 right-0 bottom-0">
      </div>
      <svg class="absolute w-[50%] h-[50%] top-1/2 left-1/2 bottom-1/2 -translate-x-1/2 -translate-y-1/2" viewBox="0 0 20 22" fill="none"
    ...
    <div class="flex justify-center max-w-[500px] w-full mx-auto bg-purple-300 mt-5 rounded p-5 border-purple-500 border-1">
      <div class="">
        <div class="text-lg text-purple-700 font-medium flex flex-col">
          <span>Name: </span>
          <span class="text-black font-extrabold">Ivan Ivanov</span>
        </div>
        ...
        <div class="text-lg text-purple-700 font-medium mt-1 flex flex-col">
          <span>Gender: </span>
          <span class="text-black font-extrabold">Male</span>
        </div>
        <div class="border-b border-y-purple-500 opacity-50 mt-1"></div>
        <div class="text-lg text-purple-700 font-medium mt-1 flex flex-col">
          <span>Email: </span>
          <span class="text-black font-extrabold">john@example.com</span>
        </div>
        <div class="border-b border-y-purple-500 opacity-50 mt-1"></div>
        <div class="text-lg text-purple-700 font-medium mt-1 flex flex-col">
          <span>Phone: </span>
          <span class="text-black font-extrabold">+1 (123) 456-7890</span>
        </div>
        <div class="border-b border-y-purple-500 opacity-50 mt-1"></div>
        <div class="text-lg text-purple-700 font-medium mt-1 flex flex-col">
          <span>Address: </span>
          <span class="text-black font-extrabold">123 Main St, New York, USA</span>
        </div>
      </div>
    </div>
    <button class="flex fill-white justify-center items-center bg-purple-500 text-white text-xl font-medium py-2 w-full max-w-[500px] rounded-lg cursor-pointer mt-5 hover:bg-purple-700 transition ">
      <svg class="mr-2 mt-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M2 12c0 .999.381 1.902.989 2.604l-1.098.732-.587.392c-.814-1.025-1.304-2.318-1.304-3.728 0-3.313 2.687-6 6-6h9v-3l6 4-6 4v-3h-9c-2.206 0-4 1.794-4 4zm20.696-3.728l-.587.392-1.098.732c.608.702.989 1.605.989 2.604 0 2.206-1.795 4-4 4h-9v-3l-6 4 6 4v-3h9c3.313 0 6-2.687 6-6 0-1.41-.489-2.703-1.304-3.728z"/></svg>
      Generate
    </button>
  </div>
  <HistoryComponent />
